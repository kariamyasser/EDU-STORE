...
{
    public partial class EmployeChangepass : Form
    {
        string username;
        Controller controllerObj;
        public EmployeChangepass(string us)
        {
            username = us;
            InitializeComponent();
        }

        private void EmployeChangepass_Load(object sender, EventArgs e)
        {
        ...
        private void Changepass_Click(object sender, EventArgs e)
        {
            ...
            {
                string query;
                query = "SELECT username from Employee where username = '" + username + "' and password='" + passhashedold + "';";
                ...
                if (privlg > 0)
                {
                    ...
                    int r = controllerObj.UpdateEmployeePass(username, passhashed);
                    if (r > 0)
                    {
