...
namespace DBapplication
{
    ...
    {
        static string DB_Connection_String = @"Data Source=DESKTOP-8LQFHVF\SQLEXPRESS;Initial Catalog=Edustore;Integrated Security=True";
        ...
        public DataTable ExecuteReader2(string query)
        {
            try
            {
                SqlCommand myCommand = new SqlCommand(query, myConnection);
