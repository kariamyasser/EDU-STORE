...
{
    public partial class StoreChangePass : Form
    {
        string username;
        Controller controllerObj;
        public StoreChangePass(string usern)
        {
            username = usern;
            InitializeComponent();
        }

        private void StoreChangePass_Load(object sender, EventArgs e)
        {
        ...
        private void Changepass_Click(object sender, EventArgs e)
        {
            ...
            {
                string query;
                query = "SELECT username from Store where username = '" + username + "' and password='" + passhashedold + "';";
                ...
                if (privlg > 0)
                {
                    ...
                    int r = controllerObj.UpdateStorePass(username, passhashed);
                    if (r > 0)
                    {
